...
// <base_dir>/<namespace>/<project>.db (alongside the project directory, not
// inside it — see the catalog design log §5).
...
// writes a .db file. Returns nil if no catalog is registered and none can be
// opened.
