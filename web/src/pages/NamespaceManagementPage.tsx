  ...
  return (
    <tr data-testid={`proj-${namespace}-${p.name}`}>
      ...
      <td className={styles.rowActions}>
        {/* future: move action — a project-attached "Move to another namespace" control
            goes in this dedicated slot, kept VISUALLY DISTINCT from Delete (separate
            placement + its own confirm flow) so it can never be confused with delete. */}
