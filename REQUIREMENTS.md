...
| **FILE-01** | Project creation and file management exposed as MCP tools. | [`docs/contracts/mcp-v1.md`](docs/contracts/mcp-v1.md) § 4 |
...
| **TRANS-01** | ~~Manual, human-triggered Japanese→English translation via Google Cloud Translation.~~ **RETIRED** (2026-06-17, B-28): once external file drag-and-drop ADD landed, on-Shoka translate-to-write became vestigial; the `translate_file` tool + `services.google_cloud` config were removed. | [`docs/contracts/mcp-v1.md`](docs/contracts/mcp-v1.md) § 4.17 (retired) |
