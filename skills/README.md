...
files). These are the skills that the future `shoka-cli skill install <name>`
(the `apt`/`npx skills` model, B-15 step b) will sync and install into a target
agent's runtime convention directory.
